...
Rectangle {
    ...
    gradient: Gradient {
        GradientStop { position: 0.0;  color: rootId.backgroundColor1 }
        GradientStop { position: 0.33; color: rootId.backgroundColor2 }
        GradientStop { position: 1.0;  color: rootId.backgroundColor3 }
    }
    ...
    Canvas {
        ...
        property variant gradient: rootId.gradient
        ...
        Timer {
            id: drawTimer
            interval: rootId.updateInterval; running: false; repeat: true
            onTriggered: {
                canvas.requestPaint();
            }
        }
