...
Item {
    ...
    MouseArea {
        ...
        onClicked: {
            cusWizardItem.currentIndex++
            if (cusWizardItem.currentIndex >= cusWizardItem.count) {
                cusWizardItem.wizardFinished()
            }
        }
    }
    ...
    CusLabel {
        ...
        text: cusWizardItem.totlaString
        font.pixelSize: 22
        color: "white"
    }
    ...
    CusLabel {
        ...
        text: cusWizardItem.operatorString
        color: "white"
    }
}
