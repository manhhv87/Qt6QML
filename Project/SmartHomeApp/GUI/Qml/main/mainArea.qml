                ...
                ColumnLayout{
                    ...
                    RowLayout{
                        ...
                        ListView{
                            ...
                            height: 52
                            model: ListModel {
                                ListElement { source: "qrc:/SmartHome/Images/spotify-client.svg" }
                                ListElement { source: "qrc:/SmartHome/Images/youtube-to-mp3.svg" }
                                ListElement { source: "qrc:/SmartHome/Images/brasero.svg" }
                                ListElement { source: "qrc:/SmartHome/Images/itunes.svg" }
                                ListElement { source: "qrc:/SmartHome/Images/brave-browser.svg" }
                                ListElement { source: "qrc:/SmartHome/Images/youtube.svg" }
                            }
            ...
            ColumnLayout{
                ...
                RowLayout{
                    ...
                    Image{
                        ...
                        height: 38
                        clip: true
                        source: "qrc:/SmartHome/Images/spotify-client.svg"
                    }
                }
