...
ComboBox {
    ...
    CusImage {
        id: baseImage
        source: cusComboBox.imgUrlNormal
        smooth: true
        visible: false
    }
        ...
        ColorOverlay {
            ...
            color: {
                if (!cusComboBox.enabled) {
                    return cusComboBox.colorDisable
                } else if (cusComboBox.pressed) {
                    return cusComboBox.colorPressed
                } else if (cusComboBox.hovered) {
                    return cusComboBox.colorHovered
                } else {
                    return cusComboBox.colorNormal
                }
            }
    ...
    popup: Popup {
        ...
        implicitHeight: Math.min(contentItem.implicitHeight, cusComboBox.defaultHeight)
