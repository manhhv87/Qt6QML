...
Window {
    ...
    property date mDate: "2024-01-02"

    Rectangle {
        width: 200
        height: width + rootId.mInt // Use the int property
        ...
        Text {
            id: mTextId
            anchors.centerIn: parent
            text: rootId.mString   // Using our mString property

            /*
                If isFemale is true, the text will be bold
                otherwise it won't be.
            */
            font.bold: rootId.isFemale ? true : false
            // font: rootId.aFont
        }
    }
