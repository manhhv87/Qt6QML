...
Rectangle {
    ...
    Item {
        ...
        onHeightChanged: {
            rootId.addContentToTabs(widgets, rootId.leftBar, rootId.alignLeft)
            rootId.addContentToTabs(widgets, rootId.rightBar, rootId.alignRight)
            rootId.addContentToTabs(widgets, rootId.topBar, rootId.alignTop)
            rootId.addContentToTabs(widgets, rootId.bottomBar, rootId.alignBottom)
        }
    }
    ...
    */
    HTabBar {
        ...
        height: 0
        width: rootId.width - ( leftBar.visible ? leftBar.width : 0 )
    ...
    VTabBar {
        ...
        width: 0
        height: rootId.height - ( topBar.visible ? topBar.height : 0 )
