    ...
    contentItem: Item {
        ...
        Grid {
            ...
            Tile {
                visible: false
                title: qsTr("Kitchen")
                source: "qrc:/SmartHome/Images/others/Ellipse 44.png"
            ...
            Tile {
                visible: false
                title: qsTr("Bedroom")
                source: "qrc:/Images/others/Ellipse 47.png"
                Layout.alignment: Qt.AlignHCenter
            ...
            Tile {
                ...
                id: roomTile
                title: qsTr("Room")
                source: "qrc:/Images/others/Ellipse 45.png"
                Layout.alignment: Qt.AlignHCenter
            ...
            Tile {
                ...
                source: "qrc:/Images/others/Ellipse 46.png"
                Layout.alignment: Qt.AlignHCenter
