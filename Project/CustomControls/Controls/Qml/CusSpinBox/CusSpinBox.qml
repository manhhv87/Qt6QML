...
SpinBox {
    ...
    CusImage {
        id: baseImage
        source: cusSpinBox.imgUrlNormal
        smooth: true
        visible: false
    }
    ...
    up.indicator: Item {
        ...
        ColorOverlay {
            ...
            cached: true
            source: baseImage
            color: (upArea.hovered || upArea.pressed) ? cusSpinBox.colorHovered : cusSpinBox.colorNormal
            rotation: 180
        }
    ...
    down.indicator: Item {
        ...
        ColorOverlay {
            ...
            cached: true
            source: baseImage
            color: (downArea.hovered || downArea.pressed) ? cusSpinBox.colorHovered : cusSpinBox.colorNormal
        }
